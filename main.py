...
_steps = [
    ...
    "data_split",
    "train_random_forest",
    # NOTE: We do not include this in the steps so
    # it is not run by mistake.
    ...
    with tempfile.TemporaryDirectory() as _:
        ...
        if "train_random_forest" in active_steps:
            ...
            _ = mlflow.run(
                ...
                parameters={
                    ...
                    "output_artifact": "output_artifact_modle_name",
                },
            )
        ...
        if "test_regression_model" in active_steps:
            ...
            _ = mlflow.run(
                ...
                "main",
                parameters={
                    "mlflow_model": "output_artifact_modle_name:latest",
